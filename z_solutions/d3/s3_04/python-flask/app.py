"""Security-header Flask solution for Day 3, S3.04."""
...
PUBLIC_DIR = SOLUTION_DIR / "public"
API_ASSET_DIR = SOLUTION_DIR / "api-assets"
SECURITY_HEADERS = {
...
PERMISSIONS_POLICY_SOLUTION = "camera=(), microphone=(), geolocation=()"
...
def create_app() -> Flask:
    ...
    def content_security_policy():
        ...
        response.headers["Content-Security-Policy"] = CSP_SOLUTION
        response.headers["Cache-Control"] = "no-store"
        return response
    ...
    def permissions_policy():
        ...
        response.headers["Permissions-Policy"] = PERMISSIONS_POLICY_SOLUTION
        response.headers["Cache-Control"] = "no-store"
        return response
...
if __name__ == "__main__":
    app.run(host="127.0.0.1", port=int(os.environ.get("PORT", "8056")), debug=False)
